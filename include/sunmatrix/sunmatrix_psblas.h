...
#define SM_CCTXT_P(A)       ( SM_CONTENT_P(A)->cctxt )

/* ----------------------------------------
 * Exported Functions for SUNMATRIX_PSBLAS
 * ---------------------------------------- */

SUNDIALS_EXPORT SUNMatrix SUNPSBLASMatrix(psb_c_ctxt *cctxt, psb_c_descriptor *cdh);
...
SUNDIALS_EXPORT int SUNMatScaleAdd_PSBLAS(sunrealtype c, SUNMatrix A, SUNMatrix B);
SUNDIALS_EXPORT int SUNMatScaleAddI_PSBLAS(sunrealtype c, SUNMatrix A);
